...
Config.MinimumSpeedUnbuckled = 2250 -- Going Over This Speed Will Cause Stress
Config.MinimumSpeed = 2100 -- Going Over This Speed Will Cause Stress
...
Config.Menu = {
    ...
    isDynamicStressChecked = false, -- isDynamicStressChecked
    isDynamicOxygenChecked = false, -- isDynamicOxygenChecked
    isChangeFPSChecked = true, -- isChangeFPSChecked
    isHideMapChecked = true, -- isHideMapChecked
