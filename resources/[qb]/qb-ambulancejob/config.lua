...
Config.DeathTime = 1 -- How long the timer is for players to bleed out completely and respawn at the hospital
Config.PainkillerInterval = 60 -- Set the length of time painkillers last (per one)
Config.HealthDamage = 1000 -- Minumum damage done to health before checking for injuries
Config.ArmorDamage = 1000-- Minumum damage done to armor before checking for injuries
Config.ForceInjury = 1000 -- Maximum amount of damage a player can take before limb damage & effects are forced to occur
Config.AlwaysBleedChance = 0 -- Set the chance out of 100 that if a player is hit with a weapon, that also has a random chance, it will cause bleeding
...
Config.MinorInjurWeapons = { -- Define which weapons cause small injuries
    [Config.WeaponClasses['SMALL_CALIBER']] = false,
    [Config.WeaponClasses['MEDIUM_CALIBER']] = false,
...
Config.MajorInjurWeapons = { -- Define which weapons cause large injuries
    [Config.WeaponClasses['HIGH_CALIBER']] = false,
    [Config.WeaponClasses['HEAVY_IMPACT']] = false,
    [Config.WeaponClasses['SHOTGUN']] = false,
...
Config.CriticalAreas = { -- Define body areas that will always cause bleeding if wearing armor or not
    ...
    ['LOWER_BODY'] = { armored = false },
    ['SPINE'] = { armored = false },
}

Config.StaggerAreas = { -- Define body areas that will always cause staggering if wearing armor or not
    ['SPINE'] = { armored = false, major = 60, minor = 30 },
    ['UPPER_BODY'] = { armored = false, major = 60, minor = 30 },
    ['LLEG'] = { armored = false, major = 100, minor = 85 },
    ['RLEG'] = { armored = false, major = 100, minor = 85 },
    ['LFOOT'] = { armored = false, major = 100, minor = 100 },
    ['RFOOT'] = { armored = false, major = 100, minor = 100 },
}
